...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      builder: (sheetContext) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const EnText('Help & Support', size: 18, weight: FontWeight.w800),
            const SizedBox(height: 6),
            const BnText('জরুরি অবস্থায় 999 বা 109 নম্বরে কল করুন।', size: 13, color: AppColors.ink2),
            const SizedBox(height: 14),
            const _SupportRow(icon: Icons.emergency_outlined, title: 'Emergency', text: 'Call 999 or press SafeHer SOS.'),
            const _SupportRow(icon: Icons.woman_outlined, title: 'Women & Children', text: 'Call 109 for support.'),
            const _SupportRow(icon: Icons.route_outlined, title: 'Safe Route', text: 'Use Route tab to find safer paths.'),
            const _SupportRow(icon: Icons.forum_outlined, title: 'Mitra / Sister Circle', text: 'Use Mitra for guidance and Sister Circle for moderated community support.'),
          ],
        ),
      ),
    );
  ...
  void _showAboutSafeHer() {
    showAboutDialog(
      context: context,
      applicationName: 'SafeHerBD',
      ...
      children: const [
        SizedBox(height: 8),
        Text('SafeHerBD is a women-safety project for SOS alerts, safe route guidance, Mitra support, moderated community posts and legal-aid resources.'),
        SizedBox(height: 8),
        Text('Emergency: 999. Women & Children Helpline: 109. This app is not a substitute for official emergency services.'),
      ],
    );
  }
              ...
              child: _loading
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        const Center(
                          child: Column(children: [
                            BnText('গণপ্রজাতন্ত্রী বাংলাদেশ সরকার',
...
class _SupportRow extends StatelessWidget {
  ...
  final String title;
  final String text;
  const _SupportRow({required this.icon, required this.title, required this.text});
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                EnText(title, size: 12.5, weight: FontWeight.w800),
                const SizedBox(height: 2),
                EnText(text, size: 11, color: AppColors.ink2),
              ],
            ),
          ),
        ]),
